...
def gconnect():
    ...
    if result.get('errr') is not None:
...
def fbconnect():
    ...
    # Exchange client token for a long-lived server-side token with
...
def deleteRestaurant(restaurant_id):
  ...
  if restaurantToDelete.user_id != login_session['user_id']:
      return """<script>
        function myfunction(){
            alert('You are not authorized to delete this restaurant. Please create your own
